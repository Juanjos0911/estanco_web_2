<%-- 
    Document   : inicio
    Created on : 10/09/2024, 05:07:33 PM
    Author     : SENA
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="carousel">
            <div class="list">
                <div class="item">
                    <img src="/estanco_web_2/imagenes/img1.jpg" alt="TODO TIPO DE CERVEZAS"/>
                    <div class="content">
                ...
                <div class="item">
                    <img src="/estanco_web_2/imagenes/img2.jpg" alt="Licores Y RON"/>
                    <div class="content">
                ...
                <div class="item">
                    <img src="/estanco_web_2/imagenes/img3.jpg" alt="MECATOS Y MÁS..."/>
                    <div class="content">
                ...
                <div class="item">
                    <img src="/estanco_web_2/imagenes/img4.jpg" alt="GASEOSAS Y ENERGIZANTES"/>
                    <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <ul style="list-style-type: none; padding: 0;">
                            <li><a href="/estanco_web_2/vista/Inicio.jsp" style="color: white;">Inicio</a></li>
        ...
        <script src="/estanco_web_2/JS/carrusel.js" type="text/javascript"></script>
    </body>
</html>
